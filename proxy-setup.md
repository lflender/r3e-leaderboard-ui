...
1. **The SDK script** — already handled: `modules/ph-lib.js` is served from your domain.
...
- [ ] Downloaded SDK: `curl -o modules/ph-lib.js "https://us-assets.i.posthog.com/static/array.js"`
- [ ] Set up reverse-proxy (Option A/B/C/D/E above)
- [ ] Set `PH_API_HOST = '/ingest'` in `modules/analytics.js`
